...
# Fix bugs from regex replacement mapping
content = re.sub(r'let GumaState\.([a-zA-Z0-9_]+) =', r'GumaState.\1 =', content)
content = re.sub(r'\{[\s]*GumaState\.([a-zA-Z0-9_]+)[\s]*:', r'{ \1:', content)
content = re.sub(r'\,[\s]*GumaState\.([a-zA-Z0-9_]+)[\s]*:', r', \1:', content)

with open(path, 'w', encoding='utf-8') as f: f.write(content)
print('Phase 2 restored')
